...
<body>
	<div id="btm">
		<div id="main">
			...
			<div id="tabs1">
				<ul>
					<li><a href="matchFriend.action" title="好友速配"><span>好友速配</span></a></li>
					<li><a href="buddyList.html" title="好友名单"><span><b>好友名单</b></span></a></li>
										...
										<c:forEach items="${friends}" var="f">
											<tr>
												...
												<td width="20%" align="center">
													<c:if test="${f.gender==0}">
													男
													</c:if>
													<c:if test="${f.gender==1}">
													女
													</c:if></td>
												...
												<td width="10%" align="center"><img
													...
													onclick="window.location='pages/messenger/moveToBlackList.do?blackName=briup2'"
