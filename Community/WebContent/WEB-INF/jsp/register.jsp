     ...
     <div id="center">
       ...
       <div id="ltd">
	     ...
	     <TABLE cellSpacing=0 cellPadding=0 border=0>
	  			<TR>
    				<TD width="100%">
     					<FORM onSubmit="return validateRegisterForm(this);" action=register.action method=post name="reg">
     						<TABLE width="100%">
        						<thead>
        						<TR>
         							<TH colSpan=3>
								...
								<TBODY>
       							<TR>
         							<TH width="25%">
          							...
          							<TD width="30%"><INPUT id="nickname_1" maxLength=14 name=nickname style="width:200px" onblur="isNicknameExit()"></TD>
								...
								<TR>
								  ...
								  <TH><IMG alt=authCode src="authImg.do" /> 
								</TH></TR>
								<tfoot>
								<TR>
								  <TD colSpan=3>
