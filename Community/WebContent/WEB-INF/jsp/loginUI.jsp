...
<body>
	...
	<form action="login.action" method="post">
		...
		<div class="inset">
			...
			<td><label for="email">验证码： </label><input type="text"
				name="code" style="width: 80px" /></td>
			<td><img src="authImg.do" height:20px; width:60px"/></td>
			<td><a href="javascript:location.reload();">看不清？</a></td>
			<p>
				<input type="checkbox" name="remember" id="remember"> <label
					for="remember">Remember me for 1 hour</label>
			</p>
		</div>
		<p class="p-container">
